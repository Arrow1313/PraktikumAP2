...
%hier sollen zuerst !alle! errechneten werte entweder in ganzen sätzen genannt, oder in tabellen(übersichtlicher) dargestellt, sowie auf die verwendeten formeln verwiesen werden. die referenzierung der formel kann in der überschrift stehen.
%es soll immer kurz erwähnt werden (vor der tabelle), warum wir das ganze ausrechnen bzw. was wir dort ausrechnen.
...
%bei plots darauf achten, dass die achsenbeschriftung (auch die tics) die richtige größe hat und die Legende im plot nicht die Messwerte verdeckt
%zusätzlich soll in diesem teil die aufgabenstellung abgehandelt werden.
\subsection{Diskussion}
%es geht hier immer darum die gemessenen werte und die bestimmten werte über die messfehler mit literaturwerten oder untereinander zu vergleichen.
...
%in einem satz soll dann kurz angesprochen werden, wie gut unser fehler und damit unsere messung ist.
...
%--------------------------------------------------------------------------------------------
%falls die tabellen mit den messwerten zu lang werden, kann die section mit den messwerten auch hinter die Diskussion platziert werden (bzw. eine section mit dem anhang eingefügt werden)
\section{Fazit}
