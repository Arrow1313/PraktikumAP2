...
Wir bauen den in der folgenden Abbildung 
...
\begin{align}
\xi = \tan^{-1}\left(\frac{X-x}{2 \Delta L}\right)
...
Der Fehler berechnet sich nach der folgenden Formel:
\begin{align}
\sigma_\xi = \sqrt{
\left(\frac{\sigma_X}{2 \Delta L\left(1+\left(\frac{X-x}{2 \Delta L}\right)^2\right)}
\right)^2+
\left(\frac{\sigma_x}{2 \Delta L\left(1+\left(\frac{X-x}{2 \Delta L}\right)^2\right)}
\right)^2+
\left(\frac{X-x}{2 (\Delta L)^2\left(1+\left(\frac{X-x}{2 \Delta L}\right)^2\right)}\sigma_{\Delta L}
\right)^2}
\label{eqn:winkeldivergenz_sigma}
\end{align}
...
\multicolumn{1}{|r|}{2,0} & \multicolumn{1}{r|}{0,5} \\ \hline
Weitung/mm & Fehler/mm \\ \hline
\multicolumn{1}{|r|}{12} & \multicolumn{1}{r|}{1} \\ \hline
...
Für die  Bestimmung der  der Winkeldivergenz wurde Gleichung \ref{eqn:winkeldivergenz} und Gleichung \ref{eqn:winkeldivergenz_sigma} für den Fehler verwendet. Es ergab sich eine Winkeldivergenz von 0,0470 $(\pm 0,0002)$ Grad.
