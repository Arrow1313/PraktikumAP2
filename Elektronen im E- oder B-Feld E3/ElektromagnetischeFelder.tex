...
Für eine Beschleunigungsspannung von 1350V ergab sich die Regressionsgerade mit f(x)=$0,246 (\pm 0,001) x  + 2,13E-013	 (\pm 0,01)$, mit einem $\chi^2$ von 0,0333333.
...
Für eine Beschleunigungsspannung von 475V ergab sich die Regressionsgerade mit f(x)=$0,728 (\pm 0,005) x - 0,22 (\pm 0,07)$, mit einem $\chi^2$ von 0.533333.
...
Für U$_\text{B} \circ \text{k}$ ergab sich der Mittelwert 335 $(\pm 11)$ mm für die X-Achsenauslenkung und ein Wert von 872	$(\pm 21)$ mm.
...
Für k$_\text{s} \circ \text{U}_\text{S}$
