...
=======
Bei den Minima wurden die gleichen Formeln verwendet, wobei $U_max$ durch $U_min$ zu ersetzen ist. Für die Berechnung von $U_A$ aus den Minima wurde Gleichung \ref{eqn:u_a} und für den Fehler Gleichung \ref{eqn:u_a_delta} verwendet. ($U_min$ durch $U_max$ ersetzen)

>>>>>>> 90a72e959d272c504c68f9f087167aaaf259d083
\begin{table}[H]
