...
\end{enumerate}
\subsection{Diskussion}
Im ersten Teil dieser Aufgabe sollte die Knotenspannung an einem Spannungsteiler ausgemessen und mit dem Theoriewert verglichen werden. Im zweiten Teil sollte die Halbwertszeit der Entladung des Tiefpasses bestimmt und mit dem Theoriewert verglichen werden. Im dritten bis sechsten Teil sollten die Grenzfrequenzen von Hoch-, Tief- und Bandpass bestimmt werden und mit den Theoriewerten verglichen werden.
Dabei wurde für den Hochpass eine RC und zusätzlich eine RL Schaltung untersucht.
\section{Aufgabe 3}
\subsection{Praktische Durchführung}
