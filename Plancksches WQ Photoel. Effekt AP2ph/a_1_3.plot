...
plot "a_1_3.dat" with errorbars title "Messdaten", f(x) title "Regressionsgerade"#, g(x) title "Untere Fehlergrenze", h(x) title "Obere Fehlergrenze"

set terminal postscript eps enhanced color font 'Helvetica,10'
set output "a_1_3.eps"
