...
\begin{align}
\text{R}_X = \frac{\text{R}_0\text{R}_2}{\text{R}_1}
\end{align}
Mit dem Fehler:
\begin{align}
\sigma_{\text{R}_X} = \sqrt{
\left(\frac{\text{R}_2}{\text{R}_1}\sigma_{\text{R}_0}\right)^2+
\left(\frac{\text{R}_0}{\text{R}_1}\sigma_{\text{R}_2}\right)^2+
\left(\frac{\text{R}_0\text{R}_2}{\text{R}_1^2}\sigma_{\text{R}_1}\right)^2}
\end{align}
%Formel und Fehlerformel für R1 und R2 fehlen noch
\item[d)]
