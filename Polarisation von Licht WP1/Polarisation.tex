...
einer Zuckerlösung\\
\begin{enumerate}
\item Wir stellen eine Zuckerlösung bekannter Konzentration q (in [$\frac{\text{g}}{\text{cm}^3}]$)
...
\item Anschließend stellen wir eine weitere Zuckerlösung mit einer anderen Konzentration als
...
\begin{enumerate}
\item Wir haben in allen bisherigen Versuchen im Praktikum immer nur die Wechselwirkung
...
\item[6.]
\begin{enumerate}
\item Für die spezifische Drehung [$\alpha$] gilt die Beziehung:
\begin{align}
\alpha = [\alpha] q d
\end{align}
